...
public class ChangKu extends IoHandlerAdapter {
    ...
    public static void main(String[] args) {
        ...
        // 进入仓库首页
        String CangkuSURL = "https://cangku.moe/archives/177481";
        //String CangkuSURL = "http://127.0.0.1:8080/ufo233";
        ...
        WebElement link = webDriver.findElement(By.className("dl-item"));
        System.out.println("按下网盘");
        ...
        System.out.println("跳转页面为:" + pageUrl);
        tool.closeWindow(webDriver);

        //https://www.cnblogs.com/marton/p/11391854.html#_lab2_0_7
        //https://www.cnblogs.com/stevenx/p/7143295.html
        ...
        try {
            ...
            for (int i = 1; i < testno3.length; i++) {
                ...
                if (NRPHtmlText.contains("404 not found")) {
                    ...
                    listmap.addAll(first_no3(webDriver, NRPHtmlText, ChangKuID));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public List<Map<String, Object>> first_no3(WebDriver webDriver, String NRPHtmlText, String ChangKuID) {
        List<Map<String, Object>> listmap = new ArrayList<Map<String, Object>>();
        String type;
        String panName;
        String tiqu;
...
//			endIndex = textno1.indexOf("</h1>");
			...
			textno2 = textno1.substring(beginIndex);
			endIndex = textno2.indexOf("</a>");
			textno2 = textno2.substring(0, endIndex);
...
//			endIndex = textno2.lastIndexOf("<span");
    ...
    public String GetBaiDuPan(WebDriver webDriver) {
        //成功
        System.out.println("点击开始");
        Actions actions = new Actions(webDriver);
        WebElement link = webDriver.findElement(By.className("dl-item"));
